...
The data from the sensor will be heandled by an adapter from SPI to UART (a bridge adapter) like project example that can be cloned from <a href="https://github.com/MorgothCreator/mSdk/tree/master/SDK_Probe_STM32-E407_olimex">here.
